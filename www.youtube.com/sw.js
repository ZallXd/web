...
ytcfg.set({
    "EXPERIMENT_FLAGS": {
        ...
        "kev_adb_pg": true,
        "kevlar_display_downloads_numbers": true,
        "kevlar_gel_error_routing": true,
        "kevlar_modern_downloads_extra_compact": true,
        "kevlar_modern_downloads_page": true,
        "kevlar_modern_downloads_skip_downloads_title": true,
    ...
    "INNERTUBE_CLIENT_VERSION": "2.20260105.05.00",
    "INNERTUBE_CONTEXT": {
        "client": {
            "hl": "id",
            "gl": "ID",
    ...
    "INNERTUBE_CONTEXT_CLIENT_VERSION": "2.20260105.05.00",
...
if (self.trustedTypes && self.trustedTypes.createPolicy) {
    var policy = self.trustedTypes.createPolicy('youtubeServiceWorkerPolicy', {
        createScriptURL: function(unused) {
            return 'https:\/\/www.youtube.com\/s\/desktop\/d05d3b16\/jsbin\/serviceworker-kevlar-appshell.vflset\/serviceworker-kevlar-appshell.js';
        }
    });
    importScripts(policy.createScriptURL(''));
} else {
    importScripts('https:\/\/www.youtube.com\/s\/desktop\/d05d3b16\/jsbin\/serviceworker-kevlar-appshell.vflset\/serviceworker-kevlar-appshell.js');
}